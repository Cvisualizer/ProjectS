...
function mapping(){
	...
	var prevX = 450; //1つ前のマスの右端のx座標
	var prevY = 90; //1行上のマスの下端のy座標
	...
	for(var i=0,column=0,line=0;i<obj_num;i++){
		...
		//引数:x座標、y座標、幅、高さ、色、透明度、枠線の色、枠線の幅
			rises[i]=generateUI(prevX,prevY,riseW/2,riseH/2,"orange",0,"black",5);
			rise_type[i]=0;
		...
		//引数:x座標、y座標、幅、高さ、色、透明度、枠線の色、枠線の幅
			rises[i]=generateUI(prevX,prevY,riseW,riseH,"orange",0,"black",5);
			rise_type[i]=1;
